...
function KellyColorPicker(ca) {
  ...
  function N(a, b) {
    ...
    if (7 >= a.length)
      ...
      if (3 <= e.length && 4 >= e.length) {
        ...
        e[0] = e[0].replace("rgb(", "");
        var f = { r: parseInt(e[0]), g: parseInt(e[1]), b: parseInt(e[2]) };
        if (
          255 >= f.r &&
          255 >= f.g &&
          255 >= f.b &&
      ...
      for (var f = 0; f < this.size; f++)
        for (var g = 0; g < this.size; g++) {
          var h = { x: g + c, y: f + d },
            k = this.dotToSv(h),
            l = Math.abs(k.v - a.v);
          if (Math.abs(k.s - a.s) < e && l < e) return h;
        }
      return { x: 0, y: 0 };
    };
  ...
  function ia() {
    if (T.triangle) return T.triangle;
    var a = {};
    a.size;
    a.padding = 2;
    a.path;
  ...
  function ea() {
    ...
    "CANVAS" != D.tagName &&
      ((D.style.width = a + "px"), (D.style.height = u + "px"));
    n.width = a;
    n.height = u; /*O!=n&&(n.style.width=a+"px",n.style.height=u+"px")*/
    for (a = 0; a <= k.length - 1; ++a) k[a].updateSize();
    w &&
  ...
  function W(a) {
    if (t && (!l.updateinput || (0, l.updateinput)(g, t, a))) {
      var b =
        "rgba(" + E.r + ", " + E.g + ", " + E.b + ", " + F.toFixed(2) + ")";
      a ||
        (t.value =
          1 > F && "mixed" === aa ? b : "hex" === aa || "mixed" === aa ? H : b);
      na &&
        ((t.style.color = 0.5 > m.v ? "#FFF" : "#000"),
  ...
  function ta() {
    if (!D) return !1;
    "CANVAS" != D.tagName
      ? ((n = document.createElement("CANVAS")), D.appendChild(n))
      : (n = D);
  ...
  function pa(a) {
    for (var b = !1, c = 0; c <= k.length - 1; ++c)
      k[c].selected && (b = c), (k[c].selected = !1);
    ...
    d && l.selectcolorsaver && (0, l.selectcolorsaver)(g, k[a]);
    d || !1 === b || (k[b].selected = !0);
    return d;
  }
  function fa() {
    for (var a = 0; a <= k.length - 1; ++a) k[a].selected && (k[a].color = H);
  }
  function qa() {
    if (k.length) for (var a = 0; a <= k.length - 1; ++a) k[a].draw();
  }
  function ua() {
    if (!e) return !1;
    e.clearRect(0, 0, n.width, n.height);
    if (K) return e.putImageData(X, 0, 0), qa(), !0;
    h.draw();
    y.draw();
    C && r.draw();
    qa();
    w && w.draw();
    A || ((X = e.getImageData(0, 0, n.width, n.height)), (K = !0));
    return !0;
  }
  function M() {
    if (!ua()) return !1;
    ...
    e.closePath();
    e.strokeStyle =
      0.5 < m.v && 0.5 > m.s ? "rgba(0, 0, 0, 1)" : "rgba(255, 255, 255, 1)";
    e.beginPath();
    e.lineWidth = 2;
  ...
  r.updateSize = function() {
    this.pos = { x: u + r.padding, y: r.padding };
  ...
  var L = {
    ...
    initSvCursor: function() {
      ...
      if (this.svCursorData) return (a.style.cursor = this.svCursorData), !0;
      if (!v) return !1;
      var b = this.size + 2;
      v.width = b;
      v.height = b;
      ...
      -1 === a.style.cursor.indexOf(c) &&
        ((this.svCursorData = "crosshair"), (a.style.cursor = "crosshair"));
      return !0;
    },
    initStandartCursor: function() {
      this.stCursor &&
        ((L.curType = 0), (document.body.style.cursor = this.stCursor));
    },
    updateCursor: function(a) {
      sa &&
        (KellyColorPicker.cursorLock ||
          (y.isDotIn(a) ? L.initSvCursor() : L.initStandartCursor()));
    }
  };
  this.popUpClose = function(a) {
    if (!1 !== p.tag) {
      if (a && (a.target == t || a.target == n || a.target == p.tag)) return !1;
      p.tag.style.display = "none";
      KellyColorPicker.activePopUp == g && (KellyColorPicker.activePopUp = !1);
    }
  };
  this.popUpShow = function(a) {
    if (!1 !== p.tag && (!l.popupshow || (0, l.popupshow)(g, a))) {
      ...
      b =
        parseInt(p.tag.style.paddingBottom) + parseInt(p.tag.style.paddingTop);
      0 >= b && (b = 0);
  ...
  this.mouseMoveRest = function(a) {
    if (!A && J) {
      ...
      l.mousemoverest && (0, l.mousemoverest)(a, g, b);
    }
  };
  ...
  this.wheelMouseMove = function(a, b) {
    ...
    if (A && J) {
      ...
      g.setHueByDot(c);
      l.mousemoveh && (0, l.mousemoveh)(a, g, c);
    }
  };
  ...
  this.alphaMouseMove = function(a, b) {
    ...
    if (A && J) {
      ...
      g.setAlphaByDot(c);
      l.mousemovealpha && (0, l.mousemovealpha)(a, g, c);
    }
  };
  this.alphaMouseUp = function(a, b) {
    ...
    if (A) {
      ...
      var c = Q(a);
      L.updateCursor(c);
      l.mouseupalpha && (0, l.mouseupalpha)(a, g, c);
    }
  };
  this.svMouseMove = function(a, b) {
    ...
    if (A && J) {
      ...
      g.setColorByDot(c);
      l.mousemovesv && (0, l.mousemovesv)(a, g, c);
    }
  };
  this.svMouseUp = function(a, b) {
    ...
    if (A) {
      ...
      L.updateCursor(c);
      C && ((K = !1), M());
      l.mouseupsv && (0, l.mouseupsv)(a, g, c);
    }
  };
  ...
  this.setColorSaver = function(a) {
    if (!a) return !1;
    for (var b = 0; b <= k.length - 1; ++b)
      if (k[b].align == a) return pa(b), k[b];
  };
  this.updateView = function(a) {
    if (!e) return !1;
    a && ((h.imageData = null), (X = y.imageData = null));
    K = !1;
    ea();
    M();
    return !0;
  ...
  this.setMethod = function(a) {
    ...
    "triangle" == B && (y = ia());
    g.resize(u, !0);
    l.setmethod && (0, l.setmethod)(g, B);
    return !0;
  };
  this.destroy = function() {
    if (!g) return !1;
    0 < L.curType &&
      ((KellyColorPicker.cursorLock = !1), L.initStandartCursor());
    A &&
      (q(document, "mouseup", "action_process_"),
      q(document, "mousemove", "action_process_"),
      q(document, "touchend", "action_process_"),
  ...
  (function(a) {
    ...
    a.input && "object" !== typeof a.input
      ? ((a.input = document.getElementById(a.input)), (t = a.input))
      : "object" === typeof a.input && (t = a.input);
    ...
    a.place
      ...
      ? ((p.tag = document.createElement("div")),
        ...
        a.popupClass
          ? (p.tag.className = a.inputClassName)
          : ((p.tag.className = "popup-kelly-color"),
...
KellyColorPicker.attachToInputByClass = function(ca, S) {
  for (
    var V = [], R = document.getElementsByClassName(ca), N = 0;
    N < R.length;
    N++
  )
    S ? (S.input = R[N]) : (S = { input: R[N], size: 150 }),
